  ...
  return (
    <div className="bg-gray-50 min-h-full">
      <header className="sticky top-0 bg-white/80 backdrop-blur-sm z-10 px-4 pt-8 pb-4 flex items-center">
        ...
        <h1 className="text-lg font-semibold text-center flex-grow -ml-4">データエクスポート</h1>
      </header>
      
      <main className="p-6 text-center">
        <div className="bg-white p-6 rounded-2xl shadow-sm">
            <Icon name="info" className="w-12 h-12 text-[#2E6EE6] mx-auto mb-4" />
            <p className="text-gray-700">
                これまでのアラートデータをCSV形式などでエクスポートできます。
            </p>
